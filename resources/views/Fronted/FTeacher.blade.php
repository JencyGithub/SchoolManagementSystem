            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        ...
                        <div class="text pt-3 text-center">
                            ...
                            <span class="position mb-2">Vocational Cource Teacher</span>
                            <div class="faded">
                                <p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
                            </div>
                        </div>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        ...
                        <div class="text pt-3 text-center">
                            <h3>Mitch Parker</h3>
                            <span class="position mb-2">physical Education Teacher</span>
                            <div class="faded">
                                <p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
                            </div>
                        </div>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        ...
                        <div class="text pt-3 text-center">
                            <h3>Stella Smith</h3>
                            <span class="position mb-2">Social Studies Teacher</span>
                            <div class="faded">
                                <p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
                            </div>
                        </div>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        ...
                        <div class="text pt-3 text-center">
                            <h3>Monshe Henderson</h3>
                            <span class="position mb-2">Consumer Education Teacher</span>
                            <div class="faded">
                                <p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
                            </div>
                        </div>
