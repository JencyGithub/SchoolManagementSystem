                ...
                <div class="col-12 col-lg-9 col-xl-7">
                    <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <form action="{{route('UpdateStudentSave',$all->id)}}">
                                <div class="row">
                                    <div class="col-md-4 mb-4">
                                        <div class="form-outline">
                                            <input type="text" value="{{ $all->FirstName }}" name="FirstName" id="Sname"
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <div class="form-outline">
                                            <input type="text" value="{{ $all->MiddleName }}" name="MiddleName" id="Fname"
                                                class="form-control form-control-lg" autocomplete="off"/>
                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="form-outline">
                                            <input type="text" value="{{ $all->LastName}}" name="LastName" id="Lname"
                                                class="form-control form-control-lg" autocomplete="off"/>
                                ...
                                <div class="row">
                                    <div class="col-md-8 mb-4">
                                        <div class="form-outline">
                                            <input type="text" value="{{ $all->Address }}" name="Address" id="Address"
                                                class="form-control form-control-lg" autocomplete="off"/>
                                    ...
                                    <div class="col-md-4">
                                        <select name="Religion" class="select form-control-lg w-100">
                                            ...
                                            <option {{$all->Religion=='Hindu'?'selected':''}}>Hindu</option>
                                            <option {{$all->Religion=='Jain'?'selected':''}}>Jain</option>
                                            <option {{$all->Religion=='Christian'?'selected':''}}>Christian</option>
                                        </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4 d-flex align-items-center">
                                        <div class="form-outline datepicker w-100">
                                            <input type="Number" value="{{ $all->MobileNo}}" name="MobileNumber" class="form-control form-control-lg"
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input {{$all->Gender=='Female'?'checked':''}} class="form-check-input" value="Female" name="Gender" type="radio"
                                                 id="femaleGender" />
                                            <label class="form-check-label" for="femaleGender">Female</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input {{$all->Gender=='Male'?'checked':''}} class="form-check-input" value="Male" name="Gender" type="radio"
                                                id="maleGender"/>
                                            <label class="form-check-label" for="maleGender">Male</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input {{$all->Gender=='Other'?'checked':''}} class="form-check-input" name="Gender" type="radio"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-4 pb-2">
                                        <select name="Class" class="select form-control-lg w-100">
                                            ...
                                            <option {{$all->Class==$cls->Class?'selected':''}}>{{$cls->Class}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-4 mb-4 pb-2">
                                        <select name="Year" class="select form-control-lg w-100">
                                            ...
                                            @foreach($Year as $yer)
                                            <option {{$all->Year==$yer->Year?'selected':''}}> {{$yer->Year}} </option>
                                            @endforeach
                                        </select>
